...
$t_{\text{P1 освобождает R2}} = (L/R_S + d_{\text{распр1}}) + L/R_C$
...
$t_{\text{P2 прибытие марш}} = (L/R_S + T) + L/R_S + d_{\text{распр1}}$
...
$t_{\text{P2 прибытие марш}} \geq t_{\text{P1 освобождает R2}}$
